...
describe('reconcileNotifications', () => {
  ...
  it('creates notifications for cards in attention states', async () => {
    const cards = [
      ...
      makeCard({ id: 'card-2', agentStatus: 'blocked', agentRuns: [{ id: 'run-2', cardId: 'card-2', columnId: null, role: 'backend-engineer', status: 'blocked', attempt: 1, startedAt: '', endedAt: null, output: '', blockedReason: 'Need credentials', sessionId: null, retryAfterMs: null, error: null }], currentAgentRunId: 'run-2' }),
