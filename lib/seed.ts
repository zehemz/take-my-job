...
export const initialState: KobaniStore = {
  boards: [
    { id: 'board-1', name: 'Sprint 12 Board', createdAt: MINUS_2D, githubRepo: null },
    { id: 'board-2', name: 'Content Pipeline', createdAt: MINUS_2D, githubRepo: null },
    { id: 'board-3', name: 'Platform Docs', createdAt: MINUS_1D, githubRepo: null },
  ],
